...
bot_token = '1234567890:AAqwertyuiioop'
# ID чата
chat_id = '0987654321'
# Создаем бота
...
client.subscribe("zigbee2mqtt/639b. ВАННАЯ Клапан горячей воды/state")
...
#    print(curr_topic_value)
    # Делаем мапинг содержимого (для человекочитаемости)
    if curr_topic_value == 'ON':
     mapp_topic_value = 'Горячая вода перекрыта'
    if  curr_topic_value == 'OFF':
     mapp_topic_value = 'Горячая вода включена'
